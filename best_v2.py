...
==============================================================================
Automatski izabran broj režima: 6
HMM pronađenih stanja: 6
Poslednji režim: 3
...
==============================================================================
Dominantni spektralni indeks: 554
Dominantna spektralna jačina: 0.018188324
Entropija: 10.401195608
  lag 01: -0.008502561
  lag 02: +0.014208761
  lag 03: -0.055780931
  lag 05: -0.002851541
...
==============================================================================
De Bruijn čvorova: 1,773
De Bruijn simbol nastavka: None

==============================================================================
6. GRADIENT BOOSTING I EXTRA TREES
==============================================================================
Extra Trees validacioni MAE: 0.247189683
Gradient boosting validacioni MAE: 0.252618288

==============================================================================
7. VREMENSKI TRANSFORMER
==============================================================================
  Transformer epoha 1/4 — gubitak 0.12253624
  Transformer epoha 2/4 — gubitak 0.08695973
  Transformer epoha 3/4 — gubitak 0.09709983
  Transformer epoha 4/4 — gubitak 0.08971070
Transformer validacioni MAE: 0.244226426

==============================================================================
8. BAJESOVO PONDERISANJE KANDIDATA
==============================================================================
  Gradient boosting            težina=0.340232705 gubitak=0.800645682
  Vremenski Transformer        težina=0.331177937 gubitak=0.822841001
  Extra Trees                  težina=0.328589358 gubitak=0.829297821

==============================================================================
9. NESTED WALK-FORWARD VALIDACIJA
==============================================================================
  Fold 1/5 — obuka 829 — provera 237 — prosek pogodaka 1.194093 — potpuno tačnih 0
  Fold 2/5 — obuka 1,066 — provera 237 — prosek pogodaka 1.236287 — potpuno tačnih 0
  Fold 3/5 — obuka 1,303 — provera 237 — prosek pogodaka 1.164557 — potpuno tačnih 0
  Fold 4/5 — obuka 1,540 — provera 237 — prosek pogodaka 1.227848 — potpuno tačnih 0
  Fold 5/5 — obuka 1,777 — provera 119 — prosek pogodaka 1.117647 — potpuno tačnih 0
Broj hronoloških provera: 1,067
Prosečan broj pogodaka: 1.195876
Potpuno tačnih prelaza: 0
Netačnih prelaza: 1,067

==============================================================================
10. ZAKLJUČANI ZAVRŠNI HOLDOUT
==============================================================================
Broj holdout provera: 593
Prosečan broj pogodaka: 1.234401
Potpuno tačnih prelaza: 0
Netačnih prelaza: 593
Raspodela pogodaka:
  0 pogodaka: 134
  1 pogodaka: 239
  2 pogodaka: 171
...
Detekcija skrivenih režima                       PROŠLO        režima=6
Hidden Markov / switching-state model            PROŠLO        stanja=6
...
Nested walk-forward validacija                   PROŠLO        provera=1067, prosek=1.1959, tačnih=0
Zaključani završni holdout                       PROŠLO        provera=593, prosek=1.2344, tačnih=0
...
##############################################################################
Broj kombinacija u CSV-u:          2,963
Razvojni skup:                     1,777
Zaključana validacija:             593
Završni holdout:                   593

Nested walk-forward provera:       1,067
Greške u walk-forward proveri:     1,067
Potpuno tačni walk-forward prelazi: 0
Prosečan broj pogodaka:            1.195876

Zaključanih holdout provera:       593
Greške na završnom holdoutu:       593
Potpuno tačni holdout prelazi:     0
Holdout prosek pogodaka:           1.234401
...
2. DETEKCIJA SKRIVENIH REŽIMA I HMM
==============================================================================
Automatski izabran broj režima: 5
HMM pronađenih stanja: 5
Poslednji režim: 1
...
4. SPEKTRALNA, AUTOKORELACIONA I ENTROPIJSKA ANALIZA
==============================================================================
Dominantni spektralni indeks: 489
Dominantna spektralna jačina: 0.027678116
Entropija: 9.767783152
  lag 01: +0.026141578
  lag 02: +0.057083862
  lag 03: +0.015415363
  lag 05: -0.034892984
...
5. DE BRUIJN GRAF NASTAVAKA
==============================================================================
De Bruijn čvorova: 1,027
De Bruijn simbol nastavka: None

==============================================================================
6. GRADIENT BOOSTING I EXTRA TREES
==============================================================================
Extra Trees validacioni MAE: 0.272150355
Gradient boosting validacioni MAE: 0.290422006

==============================================================================
7. VREMENSKI TRANSFORMER
==============================================================================
  Transformer epoha 1/4 — gubitak 0.08966939
  Transformer epoha 2/4 — gubitak 0.08751174
  Transformer epoha 3/4 — gubitak 0.08766426
  Transformer epoha 4/4 — gubitak 0.08555860
Transformer validacioni MAE: 0.256076008

==============================================================================
8. BAJESOVO PONDERISANJE KANDIDATA
==============================================================================
  Vremenski Transformer        težina=0.337693919 gubitak=0.810452962
  Gradient boosting            težina=0.335394735 gubitak=0.816027875
  Extra Trees                  težina=0.326911346 gubitak=0.836933798

==============================================================================
9. NESTED WALK-FORWARD VALIDACIJA
==============================================================================
  Fold 1/5 — obuka 481 — provera 137 — prosek pogodaka 1.350365 — potpuno tačnih 0
  Fold 2/5 — obuka 618 — provera 138 — prosek pogodaka 1.260870 — potpuno tačnih 0
  Fold 3/5 — obuka 756 — provera 137 — prosek pogodaka 1.321168 — potpuno tačnih 0
  Fold 4/5 — obuka 893 — provera 138 — prosek pogodaka 1.123188 — potpuno tačnih 0
  Fold 5/5 — obuka 1,031 — provera 69 — prosek pogodaka 1.275362 — potpuno tačnih 0
Broj hronoloških provera: 619
Prosečan broj pogodaka: 1.264943
Potpuno tačnih prelaza: 0
Netačnih prelaza: 619

==============================================================================
10. ZAKLJUČANI ZAVRŠNI HOLDOUT
==============================================================================
Broj holdout provera: 344
Prosečan broj pogodaka: 1.319767
Potpuno tačnih prelaza: 0
Netačnih prelaza: 344
Raspodela pogodaka:
  0 pogodaka: 70
  1 pogodaka: 136
  2 pogodaka: 98
...
Automatsko rangiranje generatora                 NIJE PROŠLO
Simbolička regresija i modularne rekurencije     NIJE PROŠLO
Detekcija skrivenih režima                       PROŠLO        režima=5
Hidden Markov / switching-state model            PROŠLO        stanja=5
k-mer, suffix i minimizer pretraga               PROŠLO
Sekvencijalno poravnanje                         PROŠLO
Spektralna, autokorelaciona i entropijska analiza PROŠLO
De Bruijn graf nastavaka                         PROŠLO
...
Vremenski Transformer                            PROŠLO
Bajesovo ponderisanje kandidata                  PROŠLO
Nested walk-forward validacija                   PROŠLO        provera=619, prosek=1.2649, tačnih=0
Zaključani završni holdout                       PROŠLO        provera=344, prosek=1.3198, tačnih=0
Jedna NEXT predikcija                            PROŠLO
...
##############################################################################
Broj kombinacija u CSV-u:          1,719
Razvojni skup:                     1,031
Zaključana validacija:             344
Završni holdout:                   344

Nested walk-forward provera:       619
Greške u walk-forward proveri:     619
Potpuno tačni walk-forward prelazi: 0
Prosečan broj pogodaka:            1.264943

Zaključanih holdout provera:       344
Greške na završnom holdoutu:       344
Potpuno tačni holdout prelazi:     0
Holdout prosek pogodaka:           1.319767
